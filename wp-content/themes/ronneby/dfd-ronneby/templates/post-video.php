...
if ($vimeo_video){ ?>
	...
	<div class="flex-video widescreen vimeo">
		<iframe src='https://player.vimeo.com/video/<?php echo esc_attr($vimeo_video); ?>?portrait=0' width='640' height='460' frameborder='0'></iframe>
	</div>
...
if ($youtube_video){ ?>
	...
	<div class="flex-video  widescreen">
		<iframe width="640" height="460" src="https://www.youtube.com/embed/<?php echo esc_attr($youtube_video); ?>?wmode=opaque" class="youtube-video" allowfullscreen></iframe>
	</div>
<?php
}
...
if( get_post_meta($post_id, "post_self_hosted_mp4",true ) ||  get_post_meta($post_id, "post_self_hosted_webm", true )) {
	...
	<video id="video-post<?php the_ID();?>" class="video-js vjs-default-skin" controls
		...
		<?php if( get_post_meta($post_id, "post_self_hosted_mp4",true ) ): ?>
			<source src="<?php echo esc_urk(get_post_meta($post_id, "post_self_hosted_mp4",true )) ?>" type='video/mp4'>
		<?php endif;?>
		<?php if( get_post_meta($post_id, "post_self_hosted_webm", true ) ): ?>
			<source src="<?php echo esc_url(get_post_meta($post_id, "post_self_hosted_webm", true )) ?>" type='video/webm'>
		<?php endif;?>
	</video>
<?php }