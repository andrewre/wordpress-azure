...
(function($) {
	...
	$(document).ready(function() {
		if($('body').hasClass('post-type-page') || $('body').hasClass('post-type-post') || $('body').hasClass('post-type-my-product') || $('body').hasClass('post-type-gallery') || $('body').hasClass('post-type-product') || $('body').hasClass('post-type-dfd-author')) {
...
//								}
			...
			var $metaBoxes				= $('#normal-sortables')
												.children('.postbox:not(#wpb_visual_composer):not(#vcwb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta):not(#the_grid_item_formats):not(.acf-postbox)')
												.clone(),
				$advancedContainer		= $('#advanced-sortables');

			$('#normal-sortables').children('.postbox:not(#wpb_visual_composer):not(#vcwb_visual_composer):not(#woocommerce-product-data):not(#wc-memberships-product-memberships-data):not(#wpseo_meta):not(#the_grid_item_formats):not(.acf-postbox)').remove();
