...
$output .= '.product-categories-carousel .cat-item .cover .cat-meta .box-name {';
	$output .= 'font-size: '. $vars['text_font-size'] .';';
$output .= '}';
$output .= '.products .product .woo-cover .buttons-wrap a.add_to_cart_button, .products .product .woo-cover .buttons-wrap a.product_type_grouped {';
...
$output .= '.products .product .woo-title-wrap .price-wrap .amount {';
	...
	$output .= 'color: '. $vars['title_color'] .';';
$output .= '}';
$output .= '.products .product.style-2 .additional-price, body.woocommerce-page .cart-wrap .shop_table tbody tr td:before {';
	$output .= 'font-style: '. $vars['box_name_font-style'] .';';
	$output .= 'font-weight: '. $vars['box_name_font-weight'] .';';
	$output .= 'font-size: '. $vars['box_name_font-size'] .';';
	$output .= 'font-family: '. $vars['box_name_font-family'] .';';
...
$output .= '.single-product p.stock {';
	...
	$output .= 'color: '. Dfd_Theme_Helpers::dfd_hex2rgb($vars['title_color'], .7) .';';
$output .= '}';
$output .= '.single-product .description, .single-product .woocommerce-product-details__short-description, .single-product .share-wrap {';
	$output .= 'border-top: 1px dotted '. $vars['border_color'] .';';
$output .= '}';
$output .= '.single-product .product-type-variable form.cart table.variations .reset_variations {';
	$output .= 'font-style: '. $vars['subtitle_font-style'] .';';
	$output .= 'font-weight: '. $vars['subtitle_font-weight'] .';';
	$output .= 'font-family: '. $vars['subtitle_font-family'] .';';
	$output .= 'line-height: '. $vars['subtitle_line-height'] .';';
	...
	$output .= 'font-size: '. ((int)$vars['subtitle_font-size'] + 1) .'px;';
$output .= '}';
$output .= '.single-product .product-type-variable form.cart table.variations .reset_variations:hover, .single-product .product-type-variable form.cart table.variations tbody > tr .value .dk-select .dk-select-options .dk-option:hover, .single-product .product-type-variable form.cart table.variations tbody > tr .value .dk-select .dk-select-options .dk-option.dk-option-selected {';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.single-product .product-type-variable form.cart table.variations tbody > tr .value .dk-select, .single-product .product-type-variable form.cart table.variations tbody > tr .value .dk-select .dk-select-options {';
...
$output .= '.single-product .single_variation_wrap .single_variation .price del {';
	$output .= 'color: '. $vars['subtitle_color'] .';';
$output .= '}';
$output .= '.single-product .product-type-grouped form.cart .woocommerce-grouped-product-list .woocommerce-grouped-product-list-item td {';
	$output .= 'border-bottom-color: '. $vars['border_color'] .';';
$output .= '}';
$output .= '.single-product .product-type-grouped form.cart .woocommerce-grouped-product-list .woocommerce-grouped-product-list-item td a {';
...
$output .= '}';
$output .= '.single-product .product-type-grouped form.cart .woocommerce-grouped-product-list .woocommerce-grouped-product-list-item td a:hover {';
...
$output .= '}';
$output .= '.single-product .product_meta > span {';
	$output .= 'font-size: '. $vars['text_font-size'] .';';
	$output .= 'color: '. $vars['subtitle_color'] .';';
$output .= '}';
$output .= '.single-product .product_meta > span .sku, .single-product .product_meta > span a {';
	$output .= 'color: '. $vars['title_color'] .';';
$output .= '}';
$output .= '.single-product .product_meta > span a:hover {';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
...
$output .= '.single-product .shop_attributes tbody tr td {';
	...
	$output .= 'color: '. $vars['title_color'] .';';
$output .= '}';
$output .= '.single-product .comment-form-author label, .single-product .comment-form-email label, .single-product .comment-form-rating label {';
	$output .= 'font-style: '. $vars['text_font-style'] .';';
	$output .= 'font-weight: '. $vars['text_font-weight'] .';';
	$output .= 'font-size: '. $vars['text_font-size'] .';';
	$output .= 'font-family: '. $vars['text_font-family'] .';';
...
$output .= '.woocommerce-message .button, .woocommerce-error .button, .woocommerce-info .button, .woocommerce-message .button.wc-backward, .woocommerce-error .button.wc-backward, .woocommerce-info .button.wc-backward {';
	$output .= 'color: '. $vars['title_color'] .';';
$output .= '}';
$output .= '.single-product .woocommerce-message .button:hover, .woocommerce-message .button:hover, .woocommerce-error .button:hover, .woocommerce-info .button:hover, .woocommerce-message .button.wc-backward:hover, .woocommerce-error .button.wc-backward:hover, .woocommerce-info .button.wc-backward:hover {';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
...
$output .= '.woocommerce p.stars a.active:before, .woocommerce-page p.stars a.active:before {';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.woocommerce-page #reviews #comments .woocommerce-Reviews-title, .woocommerce-page #reviews #review_form_wrapper #review_form #respond .comment-reply-title {';
	$output .= 'font-style: '. $vars['box_name_font-style'] .';';
	$output .= 'font-weight: '. $vars['box_name_font-weight'] .';';
	$output .= 'font-family: '. $vars['box_name_font-family'] .';';
	$output .= 'line-height: '. $vars['box_name_line-height'] .';';
...
$output .= '.cart-wrap .shop_table thead {';
	$output .= 'border-bottom: 1px solid '. $vars['border_color'] .';';
$output .= '}';
$output .= '.cart-wrap .shop_table thead th.box-name, body.woocommerce-page .cart-wrap .shop_table tbody tr td:before {';
	$output .= 'font-size: '. ((int)$vars['box_name_font-size'] - 2) .'px;';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
...
$output .= '}';
$output .= '.cart-wrap .shipping-calculator-wrap > p a {';
	$output .= 'font-style: '. $vars['box_name_font-style'] .';';
	$output .= 'font-weight: '. $vars['box_name_font-weight'] .';';
	$output .= 'font-family: '. $vars['box_name_font-family'] .';';
	$output .= 'line-height: '. $vars['box_name_line-height'] .';';
	...
	$output .= 'font-size: '. ((int)$vars['box_name_font-size'] - 2) .'px;';
$output .= '}';
$output .= '.cart-wrap .shipping-calculator-wrap .shipping-calculator-form > p select {';
	$output .= 'font-family: '. $vars['text_font-family'] .';';
	$output .= 'font-size: '. $vars['text_font-size'] .';';
	$output .= 'border-color: '. $vars['border_color'] .';';
$output .= '}';
$output .= '.cart-wrap .shipping-calculator-wrap .shipping-calculator-form > p button {';
	$output .= 'color: '. $vars['title_color'] .';';
	$output .= 'border-color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.cart-wrap .shipping-calculator-wrap .shipping-calculator-form > p button:hover {';
...
$output .= '.cart-wrap .cart_totals > h2 {';
	...
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.cart-wrap .cart_totals table tbody tr.order-total th {';
	$output .= 'font-size: '. ((int)$vars['box_name_font-size'] - 2) .'px;';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
...
$output .= '.woocommerce-page .select2-container--default .select2-results__option--highlighted[aria-selected] {';
	$output .= 'color: '. $vars['text_color'] .';';
$output .= '}';
$output .= '.woocommerce-page .dfd-login-wrap .woocommerce-info {';
	$output .= 'font-style: '. $vars['text_font-style'] .';';
	$output .= 'font-weight: '. $vars['text_font-weight'] .';';
	$output .= 'font-size: '. $vars['text_font-size'] .';';
	$output .= 'font-family: '. $vars['text_font-family'] .';';
	...
	$output .= 'color: '. $vars['subtitle_color'] .';';
$output .= '}';
$output .= '.woocommerce-page .dfd-login-wrap .woocommerce-info a {';
	$output .= 'font-style: '. $vars['box_name_font-style'] .';';
	$output .= 'font-weight: '. $vars['box_name_font-weight'] .';';
	$output .= 'font-size: '. $vars['box_name_font-size'] .';';
	$output .= 'font-family: '. $vars['box_name_font-family'] .';';
	...
	$output .= 'font-size: '. ((int)$vars['box_name_font-size'] - 2) .'px;';
$output .= '}';
$output .= '.woocommerce-page .dfd-login-wrap .woocommerce-info a:hover {';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.woocommerce-page .dfd-login-wrap form.login .clear + .form-row .button {';
	$output .= 'color: '. $vars['title_color'] .';';
	$output .= 'border-color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.woocommerce-page .dfd-login-wrap form.login .clear + .form-row .button:hover {';
	$output .= 'background: '. $vars['main_site_color'] .';';
	$output .= 'border-color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.woocommerce-page .dfd-login-wrap form.login .lost_password {';
	$output .= 'font-style: '. $vars['box_name_font-style'] .';';
	$output .= 'font-weight: '. $vars['box_name_font-weight'] .';';
	$output .= 'font-family: '. $vars['box_name_font-family'] .';';
	$output .= 'letter-spacing: '. $vars['box_name_letter-spacing'] .';';
	...
	$output .= 'font-size: '. ((int)$vars['box_name_font-size'] - 2) .'px;';
$output .= '}';
$output .= '.woocommerce-page .dfd-login-wrap form.login .lost_password:hover {';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.woocommerce-page.woocommerce-checkout .dfd-coupon-wrap .woocommerce-info {';
	$output .= 'font-style: '. $vars['text_font-style'] .';';
	$output .= 'font-weight: '. $vars['text_font-weight'] .';';
	$output .= 'font-size: '. $vars['text_font-size'] .';';
	$output .= 'font-family: '. $vars['text_font-family'] .';';
	...
	$output .= 'color: '. $vars['subtitle_color'] .';';
$output .= '}';
$output .= '.woocommerce-page.woocommerce-checkout .dfd-coupon-wrap .woocommerce-info a {';
	$output .= 'font-style: '. $vars['box_name_font-style'] .';';
	$output .= 'font-weight: '. $vars['box_name_font-weight'] .';';
	$output .= 'font-family: '. $vars['box_name_font-family'] .';';
	$output .= 'line-height: '. $vars['box_name_line-height'] .';';
	...
	$output .= 'font-size: '. ((int)$vars['box_name_font-size'] - 2) .'px;';
$output .= '}';
$output .= '.woocommerce-page.woocommerce-checkout .dfd-coupon-wrap .woocommerce-info a:hover {';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.woocommerce-page.woocommerce-checkout .dfd-coupon-wrap .checkout_coupon .button {';
	$output .= 'color: '. $vars['title_color'] .';';
	$output .= 'border-color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.woocommerce-page.woocommerce-checkout .dfd-coupon-wrap .checkout_coupon .button:hover {';
	$output .= 'background: '. $vars['main_site_color'] .';';
	$output .= 'border-color: '. $vars['main_site_color'] .';';
$output .= '}';
...
$output .= '.woocommerce-page .checkout p .chosen-container .chosen-single {';
	$output .= 'border-color: '. $vars['border_color'] .';';
$output .= '}';
$output .= '.woocommerce-page .checkout .woocommerce-billing-fields > h3 {';
	$output .= 'font-style: '. $vars['box_name_font-style'] .';';
	$output .= 'font-weight: '. $vars['box_name_font-weight'] .';';
	$output .= 'font-family: '. $vars['box_name_font-family'] .';';
	$output .= 'line-height: '. $vars['box_name_line-height'] .';';
...
$output .= '.widget_shopping_cart .widget_shopping_cart_content ul.cart_list li .mini-cart-content .box-name:hover {';
	$output .= 'color: '. $vars['main_site_color'] .';';
$output .= '}';
$output .= '.widget_shopping_cart .widget_shopping_cart_content ul.cart_list li .mini-cart-quantity {';
	$output .= 'font-style: '. $vars['text_font-style'] .';';
	$output .= 'font-weight: '. $vars['text_font-weight'] .';';
	$output .= 'font-size: '. $vars['text_font-size'] .';';
	...
	$output .= 'color: '. $vars['subtitle_color'] .';';
$output .= '}';
$output .= '.widget_shopping_cart .widget_shopping_cart_content ul.cart_list li .mini-cart-quantity .amount {';
	$output .= 'font-style: '. $vars['box_name_font-style'] .';';
	$output .= 'font-weight: '. $vars['box_name_font-weight'] .';';
	$output .= 'font-size: '. ((int)$vars['box_name_font-size'] - 1) .'px;';
	$output .= 'font-family: '. $vars['box_name_font-family'] .';';
